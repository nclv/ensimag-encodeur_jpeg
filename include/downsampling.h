 ...
 */
extern void process_Y(int16_t** Y_mcu, uint8_t hy, uint8_t vy, int16_t** data_unit);
 ...
 */
extern void process_chroma(int16_t** chroma_mcu, uint8_t hy, uint8_t vy, uint8_t h_chroma, uint8_t v_chroma, int16_t** data_unit);
